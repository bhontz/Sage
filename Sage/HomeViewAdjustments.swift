...
struct HomeViewAdjustments: View {
        ...
        var body: some View {
            NavigationView {
                VStack(spacing: 0.5) {
                    ...
                    Text("This is where a multi-line goal of the day would reside!")
                        //.font(.title)
                    ...
                    HStack {
                        VStack {
                            ...
                            NavigationLink(destination: Text("WelcomeView")
                                .navigationBarTitle("")  // for some reason you need a title (ANY title) in order to hide the navigation bar
                                .navigationBarHidden(true)
                            ) {
    ...
    struct HomeViewAdjustments_Previews: PreviewProvider {
